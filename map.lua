...
function map:draw_fort(x, y, w, h)
	self:set_block_rect("wall", x, y, w - 2, 1)
	self:set_block_rect("wall", x + w + 2, y, w - 2, 1)
	self:set_block_rect("wall", x, y + 2 * h - 1, w - 2, 1)
	self:set_block_rect("wall", x + w + 2, y + 2 * h - 1, w - 2, 1)
	self:set_block_rect("wall", x, y, 1, h - 2)
	self:set_block_rect("wall", x, y + h + 2, 1, h - 2)
...
function map:fill_main()
	self:set_block_rect("wall", 1, 1, self.width, self.height)
	self:set_block_rect("air", 2, 2, self.width - 2, self.height - 2)

	self:draw_fort(4, 4, 6, 6)
	self:draw_fort(self.width - 14, self.height - 14, 6, 6)
	self:draw_fort(4, self.height - 14, 6, 6)
	self:draw_fort(self.width - 14, 4, 6, 6)
	-- debug stuff
	...
	-- self:set_block("islope_-45", 26, 3)
	-- self:set_block("islope_-45", 27, 4)
	-- self:set_block("islope_-45", 28, 5)
	-- self:set_block_rect("wall", 29, 3, 3, 3)
	-- self:set_block("islope_45", 32, 5)
	-- self:set_block("islope_45", 33, 4)
	-- self:set_block("islope_45", 34, 3)
